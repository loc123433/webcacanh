...
foreach($danhmuc as $d){ 
    $i = 0;
?>
<h3><a class="text-decoration-none text-primary" href="index.php?action=group&id=<?php echo $d["id"]; ?>">
...
<?php 
    foreach($mathang as $m){ 
        if($m["danhmuc_id"] == $d["id"] && $i < 4){
            $i++;
?>
    <div class="col mb-5 bg-body-secondary">
        <div class="card h-100 bg-danger-subtle shadow">
            <!-- Sale badge-->
